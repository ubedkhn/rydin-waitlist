...
export const REWARD_TIERS: RewardTier[] = [
  ...
  {
    referrals: 3,
    title: "Priority Radar Unlock",
    detail: "Your ride requests are routed to drivers 60 seconds before regular users.",
  },
  {
    referrals: 5,
    referralLabel: "5+ invites",
    title: "Founding Member VIP Status",
    detail: "Permanent Founding Member Profile Badge + Access to the Rydin VIP Advisory Board.",
  },
];
...
export const LEADERBOARD: LeaderboardEntry[] = [
  ...
  { rank: 2, handle: "diksha", affiliation: "DAVV", referrals: 19, spotsSkipped: 285 },
  { rank: 3, handle: "kabir.m", affiliation: "Crystal IT Park", referrals: 16, spotsSkipped: 240 },
  { rank: 4, handle: "sunayana.s", affiliation: "MANIT Bhopal", referrals: 12, spotsSkipped: 180 },
  { rank: 5, handle: "rehanq", affiliation: "IIT Indore", referrals: 9, spotsSkipped: 135 },
  { rank: 6, handle: "sahil.k", affiliation: "BU BHOPAL", referrals: 7, spotsSkipped: 105 },
];
