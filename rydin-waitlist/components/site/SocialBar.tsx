  ...
  return (
    <div className="pointer-events-none fixed left-4 top-1/2 z-40 hidden -translate-y-1/2 xl:block">
      <nav
        ...
        className="pointer-events-auto flex flex-col items-center gap-1 rounded-2xl bg-white/90 p-1.5 shadow-lift ring-hairline backdrop-blur-xl"
      >
        {SOCIAL.map((item) => {
          ...
          return (
            <a
              ...
              className="group relative grid h-10 w-10 place-items-center rounded-xl text-slate-500 transition-colors hover:bg-brand-50 hover:text-brand-700 focus-visible:ring-2 focus-visible:ring-brand-500/60"
            >
