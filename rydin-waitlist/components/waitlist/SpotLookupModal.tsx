        ...
        >
          ...
          */}
          ...
          <motion.div
            ...
            className="relative w-full max-w-md overflow-hidden rounded-3xl bg-paper-raise p-5 shadow-float ring-hairline sm:p-6"
          >
            <div className="flex items-start justify-between gap-4">
              <div>
                <h2 id="lookup-title" className="text-lg font-semibold text-slate-900">
                  Check your spot
                </h2>
              ...
              <button
                ...
                onClick={onClose}
                aria-label="Close"
                className="rounded-lg p-1.5 text-slate-400 transition-colors hover:bg-slate-100 hover:text-slate-700 focus-visible:ring-2 focus-visible:ring-brand-500/60"
              >
            ...
            <div className="mt-5 flex items-stretch gap-2">
              <input
                ...
                className="w-full rounded-xl bg-paper-sunken px-3.5 py-2.5 text-sm text-slate-900 placeholder:text-slate-400 ring-hairline-strong focus-visible:ring-2 focus-visible:ring-brand-500/60"
              />
              <Tactile
                onClick={run}
                disabled={busy}
            ...
            <AnimatePresence mode="wait">
              {searched && result && (
                <motion.div
                  ...
                  className="mt-4 rounded-xl bg-brand-50 p-4 ring-1 ring-inset ring-brand-500/20"
                >
                  ...
                  <p
                    className="mt-1 font-mono text-3xl font-bold text-slate-900"
                    data-numeric
                  >
              ...
              {searched && !result && (
                <motion.div
                  ...
                  initial={{ opacity: 0, y: 8 }}
                  animate={{ opacity: 1, y: 0 }}
                  className="mt-4 rounded-xl bg-paper-sunken p-4 ring-hairline"
                >
                  ...
                  <button
                    ...
                    className="mt-3 text-xs font-semibold text-brand-700 underline-offset-4 hover:underline focus-visible:ring-2 focus-visible:ring-brand-500/60"
                  >
