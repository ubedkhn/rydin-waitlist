...
export function QueuePass({
  ...
  return (
    ...
    >
      <div className="relative overflow-hidden rounded-[26px] bg-paper-raise shadow-float ring-hairline">
        {/* ---------- Upper stub: the position ---------- */}
        <div className="relative px-5 pb-6 pt-5 sm:px-6">
          <div className="flex items-start justify-between gap-3">
            <span className="inline-flex items-center gap-1.5 rounded-full bg-brand-50 px-2.5 py-1 text-[11px] font-semibold uppercase tracking-wider text-brand-700 ring-1 ring-inset ring-brand-500/20">
          ...
          <div className="mt-5">
            ...
            <div className="mt-1 flex items-end gap-2">
              <motion.span
                ...
                transition={SPRING}
                className="font-mono text-5xl font-bold leading-none tracking-tight text-slate-900 sm:text-6xl"
                data-numeric
              >
                #{formatCount(standing.currentPosition)}
              </motion.span>
              {standing.totalJump > 0 && (
                <span className="mb-1 inline-flex items-center gap-1 rounded-full bg-brand-50 px-2 py-0.5 font-mono text-xs font-semibold text-brand-700 ring-1 ring-inset ring-brand-500/20">
          ...
          */}
          <dl className="mt-5 grid grid-cols-2 gap-x-4 gap-y-3 border-t border-slate-900/[0.07] pt-4">
        ...
        <div className="px-5 pb-5 pt-1 sm:px-6 sm:pb-6">
          ...
          <div className="mt-2 flex items-stretch gap-2">
            <div className="flex min-w-0 flex-1 items-center rounded-xl bg-paper-sunken px-3 ring-hairline-strong">
              <span
                id="rydin-referral-link"
                className="truncate font-mono text-xs font-medium text-brand-700"
              >
                {link}
              </span>
            </div>
            <Tactile
              ...
              className={cn(
                ...
                copied
                  ...
                  : "bg-white text-slate-700 shadow-card ring-hairline hover:bg-slate-50",
              )}
            >
              {copied ? (
                <>
            ...
            <Tactile
              ...
              className="inline-flex shrink-0 items-center justify-center rounded-xl bg-white px-3 py-2.5 text-slate-700 shadow-card ring-hairline transition-colors hover:bg-slate-50 focus-visible:ring-2 focus-visible:ring-brand-500/60"
            >
          ...
          <div className="mt-5">
            ...
            <div className="relative mt-2.5 h-1.5 rounded-full bg-slate-900/[0.08]">
              <motion.div
          ...
          <div className="mt-5 flex items-center gap-2 border-t border-slate-900/[0.07] pt-4">
            <Tactile
              ...
              className="inline-flex items-center gap-1.5 rounded-lg bg-white px-2.5 py-1.5 text-[11px] font-medium text-slate-600 shadow-card ring-hairline transition-colors hover:bg-slate-50 focus-visible:ring-2 focus-visible:ring-brand-500/60"
            >
              <UserPlus className="h-3.5 w-3.5 text-brand-600" strokeWidth={2.2} />
              Simulate an invite
            </Tactile>
            <button
              type="button"
              onClick={onReset}
              className="ml-auto inline-flex items-center gap-1 rounded-lg px-2 py-1.5 text-[11px] text-slate-400 transition-colors hover:text-slate-700 focus-visible:ring-2 focus-visible:ring-brand-500/60"
            >
              Leave the queue
...
function StubField({
  ...
  return (
    <div className="min-w-0">
      ...
      <dd
        className={cn(
          "mt-0.5 truncate text-sm text-slate-800",
