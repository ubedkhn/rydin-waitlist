  ...
  return (
    <section id="faq" className="relative px-4 py-16 sm:px-6 lg:py-24">
      <div className="mx-auto max-w-3xl">
        ...
        <Reveal>
          <h2 className="mt-6 text-display-sm font-bold text-balance text-slate-900">
            The questions people actually ask.
          </h2>
        </Reveal>

        <div className="mt-10 divide-y divide-slate-900/[0.07] overflow-hidden rounded-3xl bg-paper-raise shadow-card ring-hairline">
          {FAQS.map((faq, i) => {
              ...
              <div key={faq.question}>
                <h3>
                  <button
                    ...
                    className="flex w-full items-start gap-4 px-5 py-5 text-left transition-colors hover:bg-slate-50 focus-visible:ring-2 focus-visible:ring-inset focus-visible:ring-brand-500/60 sm:px-7 sm:py-6"
                  >
                    <span className="mt-0.5 font-mono text-[11px] font-semibold text-brand-600">
                      {String(i + 1).padStart(2, "0")}
                    </span>
                    <span
                      className={cn(
                        "flex-1 text-[15px] font-semibold leading-snug transition-colors",
                        expanded ? "text-slate-900" : "text-slate-700",
                      )}
                    >
                      {faq.question}
                    </span>
                    <motion.span
                      ...
                      className={cn(
                        ...
                        expanded
                          ...
                          : "bg-paper-sunken text-slate-500 ring-slate-900/[0.08]",
                      )}
                    >
                ...
                <AnimatePresence initial={false}>
                  {expanded && (
                    ...
                    >
                      <p className="px-5 pb-6 pl-[3.1rem] text-sm leading-relaxed text-slate-600 sm:px-7 sm:pb-7 sm:pl-[4rem]">
                        {faq.answer}
                      </p>
                    </motion.div>
                  )}
        ...
        <Reveal delay={0.1}>
          <p className="mt-6 text-center text-xs text-slate-500">
            ...
            <a
              href={SUPPORT_HREF}
              className="font-medium text-brand-700 underline-offset-4 hover:underline focus-visible:ring-2 focus-visible:ring-brand-500/60"
            >
              {SUPPORT_EMAIL}
            </a>
          </p>
