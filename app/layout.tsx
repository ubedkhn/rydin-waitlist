...
export default function RootLayout({
  ...
  return (
    ...
    <html lang="en-IN" suppressHydrationWarning>
      ...
      <body className="min-h-screen bg-paper-floor text-slate-900 transition-colors duration-300 dark:bg-slate-950 dark:text-slate-50">
        <ThemeProvider defaultTheme="system">
          ...
          */}
          <div
            aria-hidden="true"
            className="pointer-events-none fixed inset-0 -z-10 bg-[radial-gradient(125%_85%_at_50%_-10%,#FFFFFF_0%,#FDFEFE_38%,#F9FAFB_100%)] transition-opacity duration-300 dark:opacity-0"
          />
          <div
            aria-hidden="true"
            className="pointer-events-none fixed inset-0 -z-10 bg-[radial-gradient(125%_85%_at_50%_-10%,#020617_0%,#0f172a_38%,#020617_100%)] opacity-0 transition-opacity duration-300 dark:opacity-100"
          />
          {/* Map graticule, masked to a soft falloff under the hero. */}
          <div
            aria-hidden="true"
            className="pointer-events-none fixed inset-0 -z-10 bg-graticule bg-grid-72 opacity-70 [mask-image:radial-gradient(70%_50%_at_50%_0%,#000_0%,transparent_100%)] dark:opacity-20"
          />
          {children}
        </ThemeProvider>
      </body>
