...
const GLYPH_TILE =
  "grid place-items-center rounded-xl bg-brand-50 dark:bg-brand-500/10 text-brand-600 dark:text-brand-400 ring-1 ring-inset ring-brand-500/15";
    ...
    <div className="mt-6 space-y-3">
      ...
      <div>
        <div className="mb-1.5 flex items-baseline justify-between text-xs">
          ...
          <span className="font-mono font-semibold text-slate-600 dark:text-slate-300">~25%</span>
        </div>
        <div className="h-2.5 overflow-hidden rounded-full bg-paper-sunken dark:bg-slate-800 ring-hairline">
      ...
      <div>
        <div className="mb-1.5 flex items-baseline justify-between text-xs">
          <span className="text-brand-700 dark:text-brand-300">Rydin charges a flat micro-fee</span>
  ...
  return (
    <div className="relative mt-2 h-full min-h-[9rem] w-full">
      ...
      <div className="absolute bottom-0 left-0 flex gap-4">
        <span className="font-mono text-xs text-brand-700 dark:text-brand-300">800 m</span>
        <span className="font-mono text-xs text-slate-400 dark:text-slate-500">–</span>
        <span className="font-mono text-xs text-brand-700 dark:text-brand-300">1.5 km</span>
      </div>
    </div>
  );
}
        ...
        <div className="mt-10 grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-3 lg:grid-rows-[minmax(0,1fr)_minmax(0,1fr)_auto]">
          ...
          <BentoCard className="flex flex-col sm:col-span-2 lg:col-span-2 lg:row-span-2">
            <div className="flex items-center gap-2.5">
              ...
              <span className="rounded-full bg-brand-50 dark:bg-brand-500/10 px-2.5 py-1 font-mono text-xs font-semibold text-brand-700 dark:text-brand-300 ring-1 ring-inset ring-brand-500/20 dark:ring-brand-500/30">
                Save up to 50%
              </span>
            </div>
            ...
            <p className="mt-2.5 max-w-md text-sm leading-relaxed text-slate-600 dark:text-slate-300">
            ...
            <FeeComparison />
            <p className="mt-auto pt-6 text-xs text-slate-400 dark:text-slate-500">
          ...
          <BentoCard className="flex flex-col">
            ...
            <div className="mt-auto flex flex-wrap items-center gap-2 pt-5">
              <span className="inline-flex items-center gap-1.5 rounded-full bg-white dark:bg-slate-900 px-2.5 py-1 text-xs text-slate-700 dark:text-slate-200 shadow-card ring-hairline">
