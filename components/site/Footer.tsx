  ...
  return (
    <footer className="relative overflow-hidden">
      ...
      <div className="relative px-4 pb-16 sm:px-6 lg:pb-24">
        <Reveal className="mx-auto max-w-4xl overflow-hidden rounded-[2rem] bg-paper-raise dark:bg-slate-900 p-8 text-center shadow-lift ring-hairline sm:p-12">
          <div className="mx-auto inline-flex items-center gap-2 rounded-full bg-brand-50 dark:bg-brand-500/10 px-3.5 py-1.5 ring-1 ring-inset ring-brand-500/20 dark:ring-brand-500/30">
            <PulseDot />
          ...
          <h2 className="mx-auto mt-6 max-w-2xl text-display-sm font-bold text-balance text-slate-900 dark:text-slate-50">
          ...
          <p className="mx-auto mt-4 max-w-lg text-sm leading-relaxed text-slate-600 dark:text-slate-300">
            {pass && standing ? (
              <>
                You&apos;re holding pass{" "}
                <span className="font-mono text-slate-800 dark:text-slate-100">{pass.passId}</span> at
                position{" "}
              ...
              <>
                Join{" "}
                <span className="font-mono text-slate-800 dark:text-slate-100" data-numeric>
      ...
      {/* ---------- Footer proper ---------- */}
      <div className="relative border-t border-slate-900/[0.07] dark:border-slate-50/[0.07] bg-white dark:bg-slate-900 px-4 py-12 sm:px-6">
        <div className="mx-auto max-w-6xl">
          <div className="flex flex-col gap-10 lg:flex-row lg:justify-between">
            <div className="max-w-sm">
              ...
              <p className="mt-2 font-mono text-xs text-brand-600 dark:text-brand-400">
                {BRAND.tagline}
              </p>
            </div>
                      ...
                      <li key={item.id}>
                        <a
                          ...
                          {...(external
                            ...
                            : {})}
                          className="group inline-flex items-center gap-2.5 rounded-lg text-sm text-slate-600 dark:text-slate-300 transition-colors hover:text-brand-700 dark:hover:text-brand-300 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-brand-500/60"
                        >
                          <span className="grid h-8 w-8 shrink-0 place-items-center rounded-xl bg-white dark:bg-slate-900 text-slate-500 dark:text-slate-400 shadow-card ring-hairline transition-colors group-hover:text-brand-600 dark:group-hover:text-brand-400 group-focus-visible:text-brand-600 dark:group-focus-visible:text-brand-400">
                            <Icon className="h-4 w-4" strokeWidth={2.1} />
                          </span>
                          <span className="truncate transition-colors group-hover:text-brand-700 dark:group-hover:text-brand-300 group-focus-visible:text-brand-700 dark:group-focus-visible:text-brand-300">{item.handle}</span>
                        </a>
                      </li>
                    );
                  })}
          ...
          <div className="mt-12 border-t border-slate-900/[0.07] dark:border-slate-50/[0.07] pt-6">
      ...
      <ul className="mt-4 space-y-2.5">
        {links.map((link) => (
          <li key={link.label}>
            <a
              href={link.href}
              className="rounded text-sm text-slate-600 dark:text-slate-300 transition-colors hover:text-brand-700 dark:hover:text-brand-300 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-brand-500/60"
            >
              {link.label}
            </a>
          </li>
