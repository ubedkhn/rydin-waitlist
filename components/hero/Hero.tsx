    ...
    >
      ...
      <div className="relative mx-auto grid max-w-6xl items-center gap-12 lg:grid-cols-[1.05fr_0.95fr] lg:gap-10">
        ...
        <div className="max-w-xl">
          ...
          <h1 className="mt-5 text-display-lg font-bold text-balance text-slate-900 dark:text-slate-50">
          ...
          <p className="mt-5 max-w-lg text-base leading-relaxed text-slate-600 dark:text-slate-300 text-pretty sm:text-lg">
...
function TrustPoint({
  ...
  return (
    <span className="inline-flex items-center gap-2 text-sm text-slate-600 dark:text-slate-300">
      <Icon className="h-4 w-4 text-brand-600 dark:text-brand-400" strokeWidth={2.1} />
      {label}
    </span>
  );
}
